...
pub const COMMANDS: &[(&str, &str)] = &[
    ...
    ("/goal", "set, view, pause, resume or clear a persistent goal"),
    ...
    ("/debug-config", "show daemon, gateway, model and policy diagnostics"),
    ("/connect", "enter and save Sevi credentials"),
    ("/disconnect", "disconnect and forget saved Sevi credentials"),
