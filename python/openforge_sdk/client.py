...
class OpenForgeClient:
    ...
    async def execute_run(
        ...
        *,
        ...
        if docker and runner is not None:
            raise ValueError("docker and runner cannot both be specified")
        params: dict[str, Any] = {
            "repo": repo,
            "run_id": run_id,
        ...
        return await self.rpc("run/execute", params)
    ...
    async def acp_spawn(
        ...
        *,
        ...
        if cwd is not None:
            params["cwd"] = cwd
        result = await self.rpc("acp/spawn", params)
    ...
    async def budget_settle(
        ...
        return await self.rpc(
            "budget/settle",
            {"reservation_id": reservation_id, "actual_usd": actual_usd},
        )
